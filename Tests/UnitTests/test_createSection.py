...
class TestCreateSection(TestCase):
    ...
    def setUp(self):
        self.c1 = Course.objects.create(name="TemporalMechanics", number=784, onCampus=True)

        self.c2 = Course.objects.create(name="WarpTheory", number=633, onCampus=True)

        self.c3 = Course.objects.create(name="QuantumMechanics", number=709, onCampus=True)

        self.c4 = Course.objects.create(name="Linguistics", number=564, onCampus=False)
